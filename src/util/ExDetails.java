...
public class ExDetails {
	...
	public static ExDetails firstStudent() {
		return new ExDetails("207656356", "Yaniv", "Shtein",
				"yaniv.shtein@gmail.com");
	}
	
	// Put the second student details here
	public static ExDetails secondStudent() {
		return new ExDetails("207730391", "Eden", "Moshe",
				"edenmoshe160299@gmail.com");		// if there is only one student, then erase the above line, and do:
		// return null;
	}
}
